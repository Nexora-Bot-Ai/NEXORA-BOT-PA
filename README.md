# 🐺 NEXORA — WhatsApp Session Generator

![NEXORA BOT Session Generator](https://i.ibb.co/JRvZBgDK/temp.jpg)
...
```bash
git clone https://github.com/Nexora-Bot-Ai/NEXORA-BOT-PAIR
cd wolfXpair
npm install
node server.js
```
...
```js
export const CONFIG = {
  BOT_NAME:       'NEXORA BOT',          // display name
  SESSION_PREFIX: 'NEXORA-BOT',          // prefix of the session string
  TAGLINE:        'WhatsApp Device Linking',
  NAV_SUB:        'Session Generator',

  AUTHOR:         'SOUTAJIT',        // shown in post-link DM card
  DEPLOY_HOST:    'host.xwolf.space',   // your bot hosting domain
  PANEL_HOST:     'panel.xwolf.space',  // your panel domain
  GITHUB_URL:     'https://github.com/Nexora-Bot-Ai',
};
```
...
```
NEXORA-BOT - NEXORA-PAIR - Built different.
